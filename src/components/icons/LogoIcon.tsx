...
export function LogoIcon({ size = "100%" }) {
    return (
        <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" height={size}>
            ...
            <ellipse transform="matrix(0.5 0.866 -0.866 0.5 433.1796 -178.0299)" style={{ fill: "#4B3F4E" }} cx="370.771" cy="286.135" rx="82.578" ry="70.148" />
            <path style={{ fill: "#DBD9DC" }} d="M90.839,272.516c0-91.778,45.208-172.233,113.09-217.422
	...
	C154.887,474.98,90.839,381.768,90.839,272.516z"/>
            <path style={{ fill: "#5D5360" }} d="M355.097,305.548L355.097,305.548c-13.682,0-24.774-11.092-24.774-24.774v-8.258
	...
	C379.871,294.457,368.779,305.548,355.097,305.548z"/>
            <path style={{ fill: "#6F6571" }} d="M355.097,247.742v28.903c0,6.841,5.546,12.387,12.387,12.387s12.387-5.546,12.387-12.387v-4.129
	C379.871,258.834,368.779,247.742,355.097,247.742z"/>
		...
		c1.251,26.482,28.408,47.659,61.817,47.659s60.566-21.177,61.817-47.659C330.383,425.301,338.581,415.611,338.581,404.645z"/>
            ...
            <path style={{ fill: "#5D5360" }} d="M297.29,371.613c0,13.682-18.486,33.032-41.29,33.032s-41.29-19.35-41.29-33.032
	s18.486-24.774,41.29-24.774S297.29,357.93,297.29,371.613z"/>
            <path style={{ fill: "#6F6571" }} d="M338.419,403.024c-0.883-4.415-5.157-7.234-9.565-6.431c-4.435,0.81-7.387,5.097-6.653,9.544
	...
	C339.008,419.415,339.46,408.234,338.419,403.024z"/>
            <g>
                <path style={{ fill: "#4B3F4E" }} d="M272.516,396.387c-22.804,0-41.29-22.114-41.29-37.751c0-2.637,0.695-5.139,1.678-7.561
		...
		C279.837,395.747,276.243,396.387,272.516,396.387z"/>
                ...
                <ellipse transform="matrix(0.5 -0.866 0.866 0.5 -177.1563 265.3817)" style={{ fill: "#4B3F4E" }} cx="141.253" cy="286.115" rx="82.578" ry="70.148" />
            </g>
            <path style={{ fill: "#5D5360" }} d="M156.903,305.548L156.903,305.548c-13.682,0-24.774-11.092-24.774-24.774v-8.258
	c0-13.682,11.092-24.774,24.774-24.774l0,0c13.682,0,24.774,11.092,24.774,24.774v8.258
	C181.677,294.457,170.586,305.548,156.903,305.548z"/>
            <path style={{ fill: "#6F6571" }} d="M156.903,247.742v28.903c0,6.841,5.546,12.387,12.387,12.387c6.841,0,12.387-5.546,12.387-12.387
